				...
				<div class="container box_1170">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<form
								action="boardModifyDo.do?board_num=${boardDetail.board_num }"
								method="post" enctype="multipart/form-data" name="boardInput"
								id="boardInput">
								<div class="mt-10">
									<input type="text" name="board_title" placeholder="제목"
										onfocus="this.placeholder = ''"
										onblur="this.placeholder = '제목'" required class="single-input"
										value="${boardDetail.board_title}" style="background: #fdece7">
								</div>
								<div class="mt-10">
									<textarea class="single-textarea" name="board_content"
										placeholder="내용" onfocus="this.placeholder = ''"
										onblur="this.placeholder = '내용'" required
										style="height: 400px; background: #fdece7">${boardDetail.board_content}</textarea>
								</div>
								<div class="mt-20">
									<button type="button" id="btn-freeboard-upload"
										class="genric-btn orange radius">이미지 업로드</button>
									<input id="input-freeboard-file" name="board_img" type="file"
										style="display: none;"> <input type="hidden"
										name="board_img_name" value="${boardDetail.board_img_name }">
									<input type="text" id='input-freeboard-txt'
										class="single-input mt-10" value="이미지 이름" disabled
										style="background: #fdece7">
								</div>
								<div class="mt-30" style="text-align: center;">
									<img style="width: 400px; height: 400px;" id="preview-image"
										src="resources/upload/${boardDetail.board_img_name}">
								</div>
							</form>
							<div class="mt-30"
								style="text-align: center; margin-bottom: 50px;">
								<button class="genric-btn orange radius" type="submit"
									form="boardInput">글 수정</button>
