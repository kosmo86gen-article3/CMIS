    ...
    try:
        ...
        while True:
            ...
            if data:
                ...
                data = check_photo_str('E:/Workspace/Spring/imageTest/src/main/webapp/resources/image/1.jpg')
                print(data)
                connection.send(str(data[0]).encode())
                connection.send('\n'.encode())
                connection.send(str(data[1]).encode())
            else:
